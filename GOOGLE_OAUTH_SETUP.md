...
Add these URLs:
- `https://webvita.preview.emergentagent.com`
- `https://webvita.preview.emergentagent.com/dashboard`
- `http://localhost:3000` (for local testing)
...
- Solution: Make sure you added `https://webvita.preview.emergentagent.com` to Authorized JavaScript origins in Google Cloud Console
