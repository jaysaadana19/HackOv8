...
```bash
# Test auth endpoint
curl -X GET "https://webvita.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test hackathons endpoint
curl -X GET "https://webvita.preview.emergentagent.com/api/hackathons" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.goto("https://webvita.preview.emergentagent.com");
```
